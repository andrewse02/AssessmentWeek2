...
//CODE HERE
const canWeDeliver = zipCode => deliveryAreaZipCodes.includes(zipCode) ? "We can deliver to your address." : "Sorry, but we cannot reach your address.";
...
const canWeDeliverTwo = zipCode => {
    ...
    return "Sorry, but we cannot reach your address.";
}
